                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative py-4">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest">
                                <span className="px-4 bg-[#051c13] text-emerald-100/20 backdrop-blur-3xl">Or continue with</span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-black text-sm uppercase tracking-widest h-14 rounded-2xl transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3"
                        >
